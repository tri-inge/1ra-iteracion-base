...
public class Profesor implements Serializable {
    ...
    public Profesor(Integer id, String nombre, String correo, String departamento, String tipoprof, String contrasena, String numTrabajador, boolean activo) {
        this.id = id;
        this.nombre = nombre;
        this.correo = correo;
    ...
    public String toString() {
        return "com.ingenieria.biblioteca.modelo.Profesor[ id=" + id + " ]";
    }
